    ...
    public function run(): void
    {
        DB::table('obatvitamin')->insert([
            ...
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/antihistamin.jpg',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/dekongestan.png',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/ibuprofen.jpeg',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/naproxen.jpg',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/aspitin.jpg',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/azithromycin.jpg',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/levofloxacin.jpeg',
            ],
            [
                'id'    => 'b9ec7ce6-7f63-11ee-b962-0242ac120002',
                'id_obatvitamin'    =>'V12',
                'nama'  => 'Sulfamethoxazole',
                'deskripsi' => 'Sulfamethoxazole merupakan obat albuterol yang berfungsi melemaskan otot saluran pernapasan. Obat bronkitis ini termasuk dalam bronkodilator, yang ditujukan untuk melegakan saluran pernapasan.',
                'obat_dewasa'   =>'',
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/sulfamethoxazole.jpg',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/kortikosteroid.jpg',
            ],
            [
                'id'    => 'b9ec8024-7f63-11ee-b962-0242ac120002',
                'id_obatvitamin'    =>'V14',
                'nama'  => 'Benzocaine',
                'deskripsi' => 'Benzocaine merupakan obat anestesi atau bius lokal yang berbentuk obat kumur, gel, salep, dan bubuk. Cara kerja benzocaine adalah dengan menghambat sinyal saraf di dalam tubuh. Benzocaine adalah obat yang bersifat bebas. Artinya obat ini bisa dibeli di apotek baik dengan maupun tanpa resep dokter.',
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/benzocaine gel.jpg',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/cefotaxim.webp'
            ],
            [
                'id'    => 'b9ec83d0-7f63-11ee-b962-0242ac120002',
                'id_obatvitamin'    =>'V16',
                'nama'  => 'Ceftriaxone',
                'deskripsi' => 'Ceftriaxone merupakan obat untuk mengatasi penyakit akibat infeksi bakteri, seperti gonore, meningitis, otitis media, sifilis, dan penyakit Lyme. Obat ini tersedia dalam bentuk suntik.',
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/ceftriaxone.jpg',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/fluconazole.jpg',
            ],
            ...
            [
                ...
                'deskripsi' => 'Caladine powder merupakan bedak yang digunakan untuk merawat kulit bayi dari kemerahan akibat dari iritasi ringan dikarenkan pemakaian popok, udara panas atau bakteri. Bedak ini dapat pula digunakan untuk mengatasi gatal-gatal pada kulit bayi akibat gigitan serangga, sinar matahari dan biang keringat)',
                'obat_dewasa'   =>'secukupnya',
                'obat_anak' =>'secukupnya',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/caladine powder.webp',
            ],
            [
                ...
                'obat_anak' =>'Secukupnya',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/caladine lotion.webp',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/clinovir cream.webp',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/abacavir.jpeg',
            ],
            [
                ...
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/efavirenz.webp',
            ],
            [
                'id'    => 'b9ecab26-7f63-11ee-b962-0242ac120002',
                'id_obatvitamin'    =>'V23',
                'nama'  => 'Nevirapin',
                'deskripsi' => 'Nevirapin merupakan obat yang digunakan dalam pengobatan infeksi human immunodeficiency virus (HIV). Obat ini tidak bisa menyembuhkan HIV, tetapi dapat memperlambat perkembangan infeksi HIV.',
                'obat_dewasa'   =>'',
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/nevirapin.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/penisilin.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/metronidazole.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/vitamin a.jpeg',
            ],
            [
                'id'    => 'b9ecb31e-7f63-11ee-b962-0242ac120002',
                'id_obatvitamin'    =>'V27',
                'nama'  => 'Diapet',
                'deskripsi' => ' Diapet mengandung berbagai herbal, yaitu daun jambu biji, kunyit, buah mojokeling dan kulit buah delima. Ekstraksi bahan-bahan tersebut tersedia dalam bentuk sediaan kapsul.Mengonsumsinya bisa mengurangi frekuensi buang air besar, memadatkan kembali feses yang cair, dan meredakan rasa mulas akibat diare.
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/diapet.png',
            ],
            [
                'id'    => 'b9ecb490-7f63-11ee-b962-0242ac120002',
                'id_obatvitamin'    =>'V28',
                'nama'  => 'Diatabs',
                'deskripsi' => 'Diatabs bekerja dengan cara mengadsorbsi alias menyerap beberapa racun dan bakteri penyebab diare.
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/diatabs.webp',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/oralit.jpeg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/imodium.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' => 'gambar/foto_obat/entrostop.jpeg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/floxigra.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/zithromax.jpeg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/trolit.jpeg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/maltofer.png',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/tride.jpeg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/adefovir.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/entecavir.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/lamivudine.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/doxycycline.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/primaquine.webp',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/doxicor.png',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/rifampicin.webp',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/dapsone.jpg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/minocycline.jpeg',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/isoniazid.jpg',
            ],
            [
            ...
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/pyrazinamide.webp',
            ],
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/erythromycin.jpg',
            ],
            [
            ...
            [
                ...
                'obat_anak' =>'',
                'harga' => 100000,
                'gambar' =>'gambar/foto_obat/clindamycin.jpg',
            ],
